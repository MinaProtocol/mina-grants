...
- Project type: Open source 
- Enable Mina nodes to parse and verify the Mina transactions, its smart contracts and everything related. Provide an interfaces to create transactions, product blocks, and create snarks in Coda.
...
Visit [the Mina docs](https://codaprotocol.com/docs).
#### Can teams apply?
